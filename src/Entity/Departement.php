 ...
 *     fields={"nom"},
 *     errorPath="nom",
 *     message="Le departement existe deja ."
 * )
 */
class Departement
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Opportunity::class, mappedBy="departement")
     */
    ...
    public function addOpportunity(Opportunity $opportunity): self
    {
        if (!$this->opportunities->contains($opportunity)) {
            ...
            $opportunity->setDepartement($this);
        }
    ...
    public function removeOpportunity(Opportunity $opportunity): self
    {
        if ($this->opportunities->removeElement($opportunity)) {
            ...
            if ($opportunity->getDepartement() === $this) {
                $opportunity->setDepartement(null);
            }
        }
